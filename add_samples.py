...
story1 = Story(title = "Ejemplo 1", description = "Esta es una historia muy interesante", text = "Una vez fui al {} para buscarme un buen de {}", user_id = user1.id)
...
story2 = Story(title = "Example 2", description = "Esta es una historia muy aburrida", text = "Cuantos {} puedes comer. Yo solo puedo comer {}", user_id = user1.id)
...
#Add second example story
story3 = Story(title = "Example 3", description = "This is a sample story in English", text = "I like to eat {} because it is very delicous", user_id = user1.id)
